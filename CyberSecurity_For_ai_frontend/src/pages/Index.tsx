          ...
          <Card className="bg-card/60 border-border flex flex-col h-[calc(100vh-160px)]">
            <div className="flex items-center justify-between px-5 py-3 border-b border-border flex-wrap gap-2">
              ...
              <div className="flex gap-2 flex-wrap">
                ...
                <Button size="sm" variant="outline" disabled={loading}     className="text-xs font-mono h-7 border-red-700/40    text-red-300    hover:bg-red-700/10    gap-1" onClick={runFileUploadAttack}><FileWarning className="w-3 h-3" />📁 File</Button>
